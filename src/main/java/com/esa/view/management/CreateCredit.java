package com.esa.view.management;

import com.esa.domain.Client;
import com.esa.domain.CreditOffer;
import com.esa.domain.UuidMap;
import com.esa.repo.*;
import com.esa.services.BankService;
import com.esa.services.ClientService;
import com.esa.services.CreditOfferRepositoryService;
import com.esa.services.CreditService;
...
public class CreateCredit extends VerticalLayout {
    ...
    private CreditOfferRepositoryService creditOfferRepositoryService;
    ...
    public CreateCredit(ClientRepository clientRepository, UuidMapRepository uuidMapRepository,
                        ...
                        CreditOfferRepositoryService creditOfferRepositoryService) {
        this.clientRepository = clientRepository;
        this.bankRepository = bankRepository;
        this.creditRepository = creditRepository;
        this.creditOfferRepositoryService = creditOfferRepositoryService;
    ...
    private void save() {
        ...
        try {
            ...
            || amount.isEmpty() || months.isEmpty()) {
            ...
            else if (creditOfferRepositoryService.findByClientIdAndCreditId(clientRepository.findByName(nameSelect.getValue()),
                ...
                creditOfferRepositoryService.save(creditOffer);
